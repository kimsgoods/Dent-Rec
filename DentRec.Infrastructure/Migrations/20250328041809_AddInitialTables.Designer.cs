...
namespace DentRec.Infrastructure.Migrations
{
    ...
    [Migration("20250328041809_AddInitialTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentRec.Domain.Entities.MedicationCatalog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentRec.Domain.Entities.ProcedureCatalog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentRec.Domain.Entities.PatientPrescription", b =>
                {
                    ...
                    b.HasOne("DentRec.Domain.Entities.MedicationCatalog", "Medication")
                        .WithMany()
            ...
            modelBuilder.Entity("DentRec.Domain.Entities.PatientProcedure", b =>
                {
                    ...
                    b.HasOne("DentRec.Domain.Entities.ProcedureCatalog", "Procedure")
                        .WithMany()
